...
<body class="adminbody">
	...
	<div id="main">
		...
		{{ HTML::script("public/assets/js/dataTables.scroller.js") }}
		{{ HTML::script("public/assets/js/moment.min.js") }} <!-- digunakan tuk format tanggal di datatable -->
